...
const categories = [
  {
    ...
    description: "Industrial and commercial cleaning solutions for all surfaces",
    image: "/cleaningproducts/cleaningproducts.png",
    items: ["Disinfectants", "Sanitizing Wipes", "Industrial Cleaners"],
  },
  {
    id: 2,
    title: "Construction & Maintenance",
    description: "Professional tools and safety equipment for construction work",
    image: "/constructionmaintenance/constructionmaintenance.png",
    items: ["Safety Gloves", "Safety Helmets", "Construction Tools"],
  },
  {
    id: 3,
    ...
    items: ["Printer Cartridges", "Printer Paper", "Office Equipment"],
  },
  {
    id: 4,
    ...
    items: ["Disposable Gloves", "Surgical Masks", "Medical Devices"],
  },
  {
    id: 5,
    ...
    items: ["Foil & Plastic Wrap", "To-go Boxes", "Kitchen Equipment"],
  },
];
const AboutCat = () => {
  return (
