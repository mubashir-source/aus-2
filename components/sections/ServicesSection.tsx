        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-1 mb-6 lg:mb-0">
            <div className="flex items-center mb-2">
              <span className="text-primary-dark text-sm lg:text-[16px] font-medium flex items-center gap-2 bg-primary-blue/50 px-2 py-1 rounded-full">
                <GoDotFill className="text-lg lg:text-xl" /> Why Choose Us
              </span>
            </div>
            <h2 className="text-xl sm:text-2xl lg:text-[32px] font-bold text-black mb-4">
              Why Choose <span className="text-primary-blue">Alpha Universal Supplies</span>?
            </h2>
            <p className="text-gray-600 text-sm lg:text-[16px] leading-relaxed">
              We can fast-deliver supplies we deliver businesses for consistent quality, reliable shipments, and competitive pricing.
            </p>
          </div>
          ...
          {services.map((service, index) => (
            <div
              key={index}
              className="animated-border hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group"
            >
